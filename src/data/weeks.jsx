...
export const weeks = [
    ...
    },
    {
        ...
        details: (
            <div className="space-y-8">
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-accent">Histogram Equalization</h3>
                    <p className="text-gray-300 leading-relaxed text-justify">
                    ...
                    <div className="rounded-lg overflow-hidden border border-white/5 shadow-md group-hover:shadow-accent/20 transition-all duration-300 mt-4">
                        <ZoomableImage src={week3Histogram} alt="Histogram Equalization Example" className="w-full object-cover" />
                    </div>
                </div>

                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-accent">Contrast Stretching</h3>
                    <p className="text-gray-300 leading-relaxed text-justify">
                ...
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-accent">Filter Classification</h3>
                    <p className="text-gray-300 leading-relaxed text-justify">
                ...
                <div className="space-y-2">
                    <h4 className="text-accent font-bold text-center">Comparison of Filters</h4>
                    <div className="rounded-lg overflow-hidden border border-white/5 shadow-md group-hover:shadow-accent/20 transition-all duration-300">
    ...
    },
    {
        ...
        details: (
            <div className="space-y-8">
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-accent">Three Types of Degradation</h3>
                    <p className="text-gray-300 leading-relaxed text-justify">
                ...
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-accent">Types of Noise</h3>
                    <p className="text-gray-300 leading-relaxed text-justify">
                    ...
                    <div className="overflow-x-auto">
                        <table className="min-w-full text-left text-sm text-gray-300 border-collapse">
                            <thead>
                                <tr className="border-b border-gray-700 text-accent">
                            ...
                            <tbody className="divide-y divide-gray-800">
                                <tr>
                                    <td className="py-2 px-4 font-medium text-white">Gaussian Noise</td>
                                ...
                                <tr>
                                    <td className="py-2 px-4 font-medium text-white">Salt & Pepper Noise</td>
                                ...
                                <tr>
                                    <td className="py-2 px-4 font-medium text-white">Speckle Noise</td>
                                ...
                                <tr>
                                    <td className="py-2 px-4 font-medium text-white">Poisson Noise</td>
                ...
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-accent">Image Denoising Techniques</h3>
                    <h4 className="text-lg font-bold text-white">1. Spatial Domain Denoising</h4>
                    <p className="text-gray-300 leading-relaxed text-justify">
                    ...
                    <h4 className="text-lg font-bold text-white mt-4">2. Frequency Domain Denoising</h4>
                    <p className="text-gray-300 leading-relaxed text-justify">
                ...
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-accent">Evaluation Methods</h3>
                    <p className="text-gray-300 leading-relaxed text-justify">
    ...
    },
    {
        ...
        details: (
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-accent">Techniques and Details</h3>
                    <ul className="list-disc pl-6 space-y-3 text-gray-300 text-justify">
                ...
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-accent">Implementation in MATLAB</h3>
                    <p className="text-gray-300 leading-relaxed text-justify">
    ...
    },
    {
        ...
        details: (
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-accent">RGB (Red, Green, Blue)</h3>
                    <p className="text-gray-300 leading-relaxed text-justify">
                ...
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-accent">CMY (Cyan, Magenta, Yellow)</h3>
                    <p className="text-gray-300 leading-relaxed text-justify">
                ...
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-accent">HSV and HSI (Hue, Saturation, Value/Intensity)</h3>
                    <p className="text-gray-300 leading-relaxed text-justify">
                ...
                <div className="space-y-4">
                    <h3 className="text-white font-bold">Comparison of Color Models</h3>
                    <div className="overflow-x-auto">
                        <table className="min-w-full text-left text-sm text-gray-300 border-collapse">
                            <thead>
                                <tr className="border-b border-gray-700 text-accent">
                            ...
                            <tbody className="divide-y divide-gray-800">
                                <tr>
                                    <td className="py-2 px-4 font-medium text-white">Full Name</td>
                                ...
                                <tr>
                                    <td className="py-2 px-4 font-medium text-white">Type</td>
                                ...
                                <tr>
                                    <td className="py-2 px-4 font-medium text-white">Primary Usage</td>
                                ...
                                <tr>
                                    <td className="py-2 px-4 font-medium text-white">Mixing Result</td>
                                ...
                                <tr>
                                    <td className="py-2 px-4 font-medium text-white">Relation</td>
    ...
    },
    {
        ...
        details: (
            <div className="space-y-8">
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-accent">Image Compression Overview</h3>
                    <p className="text-gray-300 leading-relaxed text-justify">
                ...
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-accent">The Image Compression Flow (Pipeline)</h3>
                    <p className="text-gray-300 leading-relaxed text-justify">
                        Most compression standards, such as JPEG, follow a specific pipeline to reduce data size:
                    </p>
                    <ol className="list-decimal pl-6 space-y-4 text-gray-300 text-justify">
                        <li>
                ...
                <div className="space-y-4">
                    <h3 className="text-white font-bold">Comparison: Lossless vs. Lossy Compression</h3>
                    <div className="overflow-x-auto">
                        <table className="min-w-full text-left text-sm text-gray-300 border-collapse">
                            <thead>
                                <tr className="border-b border-gray-700 text-accent">
                            ...
                            <tbody className="divide-y divide-gray-800">
                                <tr>
                                    <td className="py-2 px-4 font-medium text-white">Definition</td>
